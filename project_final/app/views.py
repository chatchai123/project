...
def edit_profile(request):
    ...
    if request.method == 'POST':
        form = Member(request.POST, instance=user_profile)
        if form.is_valid():
        ...
        form = Member(instance=user_profile)
...
def get_line_user_info(access_token):
    user_info_url = 'https://api.line.me/v9/profile'
